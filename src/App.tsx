...
const theme = createTheme({
  palette: {
    ...
    primary: {
      light: "rgba(74, 74, 74, 0.77)",
      main: "rgba(74, 74, 74, 1)",
      dark: "rgba(61, 61, 62, 1)",
      contrastText: "#fff",
    },
    secondary: {
      light: "rgba(255, 102, 0, 0.79)",
      main: "rgba(255, 102, 0, 1)",
      dark: "rgba(192, 77, 0, 1)",
      contrastText: "#fff",
    },
    error: {
      light: "#e57373",
        ...
        {!this.state.loading && (
          <Router>
            <Switch>
              ...
              <PrivateRoute
                exact
                path="/organisation/nouvel-evenement"
                component={Event}
              />
              <PrivateRoute
                exact
                path="/organisation/evenement/:id"
                component={Event}
              />
              <PrivateRoute
                exact
                path="/organisation/plus-sur-evenement/:id"
                component={More}
              />
